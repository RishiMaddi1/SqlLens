    ...
    <div className="flex h-screen w-screen flex-col" style={{ background: '#0B0E14' }}>
      ...
      <header className="flex h-14 items-center justify-between px-6" style={{ borderBottom: '1px solid #30363D', background: '#0B0E14' }}>
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            <svg className="w-6 h-6 text-indigo-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path strokeLinecap="round" strokeLinejoin="round" d="M4 7v10c0 2 3 4 8 4s8-2 8-4V7M4 7c0 2 3 4 8 4s8-2 8-4M4 7c0-2 3-4 8-4s8 2 8 4" />
            </svg>
        ...
        <div className="flex items-center gap-4">
          <a href="https://github.com/RishiMaddi1/visual-sql-flow-mapper" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-slate-300 transition-colors">
